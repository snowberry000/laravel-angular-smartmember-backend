...
class OAuthApplication {
    ...
    public function __construct($api_key, $api_secret) {
        $this->consumerKey = $api_key;
        $this->consumerSecret = $api_secret;
    ...
    public function getAuthorizeUrl() {
        ...
        return (empty($requestToken)) ?
            $this->authorizeUrl
            :
            $this->authorizeUrl . "?oauth_token={$this->user->requestToken}";
    }
    ...
    public function getAccessToken() {
        $resp = $this->makeRequest('POST', $this->getAccessTokenUrl(),
