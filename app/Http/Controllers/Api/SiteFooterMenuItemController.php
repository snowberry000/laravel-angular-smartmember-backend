...
class SiteFooterMenuItemController extends SMController
{

    public function __construct()
    {
        parent::__construct();
        $this->model = new SiteFooterMenuItem();
    ...
    {
        //TODO: check if admin
        $pageFooterMenuItem = PageFooterMenuItem::find(Input::get("id"));
        return $pageFooterMenuItem;
        parent::update($pageFooterMenuItem);
