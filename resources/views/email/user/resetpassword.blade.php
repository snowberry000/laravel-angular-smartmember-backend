...
<div style="max-width:600px;margin:0 auto">
	...
	<p style="font-size:20px;line-height:26px;margin:0 0 25px">
		If you requested a reset for <?= $email ?>, click the button below. If you didn't make the request please ignore this email.
    ...
    <p style="font-size:12px;line-height:20px;margin:0 auto 1rem;color:#aaa;text-align:center;max-width:100%;word-break:break-word;margin-bottom:2rem">
        You may copy/paste this link into your browser:<br><a href="<?= $reset_link; ?>"
